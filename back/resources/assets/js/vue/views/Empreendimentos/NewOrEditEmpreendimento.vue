    ...
    <div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body text-center">
                        <h3 v-if="this.$route.params.id">EDITANDO EMPREENDIMENTO</h3>
        ...
        <div class="row justify-content-center">
         ...
         <div class="row justify-content-center">
           ...
           <div class="row justify-content-center" v-if="this.inputs.nome && this.inputs.numero && this.inputs.logradouro">
...
export default {
    ...
    methods: {
        ...
        atualizarEmpreendimento() {
             ...
             let url = '../public/api/v1/casa/' + this.$route.params.id                   
                axios
                    .put(url, this.inputs)
                      .then(response => {
                        console.log("atualizado")
                        console.log(response.data)
                        this.$router.push({name: 'empreendimentos', params: { tipoempreendimento: 'Todos' } });
                      }                
                    )
        ...
        getEditEmpreendimento(parametro) {
            ...
            let url = '../public/api/v1/casa/' + parametro
            axios
                .get(url)
                .then(response => {
        ...
        getClientes(){
            let url = '../public/api/v1/cliente?tipocliente=todos'
            axios
                .get(url)
                .then(response => {
