...
<div class="col-xs-12">
    <div class='box box-info'>
        ...
        <div class='box-body'>
            <form class="form-horizontal" method="post" action="<?php echo e(Route('financeiro.store')); ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <input type="date" name="inicio_conta"  id="inicio_conta" value="<?php echo e($data_atual); ?>-01" class="form-control"></input>
                    </div>
                </div>
