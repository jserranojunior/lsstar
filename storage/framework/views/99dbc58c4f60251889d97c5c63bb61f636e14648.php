...
<div class="col-md-offset-2 col-md-8">
    <div class="box box-primary">
        <div class="box-header">
            ...
            <div class="box-body">
                <form method="post" action="<?php echo e(Route('agenda.update')); ?>" class="agendamento">
                    <table class="table  table-condensed">
                       
                        <tr>
                                <td class="text-center"><label for="data"><h5>Data Agendamento</h5></label></td>
                                <td><input class="form-control" value="<?php echo e($dado->data); ?>" type="date" name="data" required></td>

                                <td class="text-center"><label for="hora"><h5>Horario Agendamento</h5></label></td>
                                <td><input class="form-control" value="<?php echo e($dado->horario); ?>" type="time" name="horario" required></td>
                        </tr>
                        <tr>
                            <td class="text-center"><label for="referencia"><h5>Referencia</h5></label></td>
                            <td><input class="form-control" value="<?php echo e($dado->referencia); ?>"  type="text" name="referencia" ></td>

                            <td class="text-center"><label for="imovel"><h5>Imóvel</h5></label></td>
                            <td><input class="form-control" type="text"  value="<?php echo e($dado->imovel); ?>"  name="imovel" ></td>
                        </tr>
                        <tr>
                            <td class="text-center"><label for="resultado"><h5>Resultado</h5></label></td>
                            <td><input class="form-control" type="text" value="<?php echo e($dado->resultado); ?>"  name="resultado" ></td>

                            <td class="text-center"><label for="expectativa"><h5>Expectativa de Negócio</h5></label></td>
                            <td><input class="form-control" type="text" value="<?php echo e($dado->expectativa); ?>"  name="expectativa" ></td>
                        </tr>
                     </table>
