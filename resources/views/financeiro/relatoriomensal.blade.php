...
<div class="parte-cima">    
            ...
            <div class="col-md-6">
                <ul class="nav nav-tabs">
                    <li class="dropdown @if($areafiltro != "Todos")filtroselect @endif">
                        ...
                        <li><a href="#" onclick="enviar('{{$ordenacao}}',{{$mes}},{{$ano}}, '{{$f_area->nome}}', '{{$contafiltro}}', '{{$pagadorfiltro}}')">{{$f_area->nome}}</a></li>
                            @endforeach
                        </ul>
                    </li>
                </ul>
    ...
    <li class="dropdown">
        ...
        <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="#" onclick="enviar('favorecido',{{$mes}},{{$ano}}, '{{$areafiltro}}', '{{$contafiltro}}', '{{$pagadorfiltro}}')">Alfabética</a></li>
                        <li><a href="#" onclick="enviar('dia',{{$mes}},{{$ano}}, '{{$areafiltro}}', '{{$contafiltro}}', '{{$pagadorfiltro}}')">Cronológica</a></li>
