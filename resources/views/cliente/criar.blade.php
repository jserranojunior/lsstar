                ...
                <table class="table text-center table-condensed"> 
                    ...
                    <span class="segundocontato" id="segundocontato">
                        ...
                        <tr class="linha-ocultar">
                            ...
                            <td><h5 class="">Telefone</h5></td>
                            <td colspan="2"><input class="form-control telefone_mascara"  name="segundotelefone" type="text"> </td>
                     ...
                     <span class="terceirocontato" id="terceirocontato">
                        ...
                        <tr class="linha-ocultar">
                            ...
                            <td><h5 class="">Telefone</h5></td>
                            <td colspan="2"><input class="form-control telefone_mascara"  name="terceirotelefone" type="text"> </td>
                        ...
                        <tr class="tr-destaque">
                            ...
                            <td><input class="form-control valor_mascara" name="casainteresse" id="casainteresse" type="text">  </td>
                           
                            <td><h5>Renda Familiar</h5></td>
                            <td colspan="2"><input class="form-control valor_mascara" id="renda" name="renda" type="text">  </td>     
                         ...
                         <tr class="tr-destaque">
                            ...
                            <td colspan="2"><input class="form-control valor_mascara" name="poupanca" id="poupanca" type="text">  </td>     
                        </tr>   
                        ...
                        <tr class="tr-destaque">
                            ...
                            <td><h5>Entrada</h5></td>
                            <td colspan="2"><input class="form-control valor_mascara" id="valorentrada" name="valorentrada" type="text">  </td>
                           
                        
                        <tr class="tr-destaque">
                            <td><h5>Financiado</h5></td>
                            <td><input class="form-control valor_mascara" name="financiado" id="financiado" type="text">  </td>
                         ...
                         <tr class="tr-destaque">
                            ...
                            <td><input class="form-control valor_mascara" name="valorprestacao" id="valorprestacao" value="" type="text">  
                        </td>
