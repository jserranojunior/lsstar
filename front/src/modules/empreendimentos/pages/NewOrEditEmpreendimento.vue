  ...
  <div>
    <div>
        ...
        <div class="col-5">
          <div class="form-group">
            <input
              ...
              class="form-control"
              v-model="inputs.numero_matricula"
            />
          </div>
        </div>
        <div class="col-5">
      ...
      <div class="row justify-content-center">
        <div class="col-5">
          <div class="form-group">
            <input
              type="text"
              placeholder="Instalação de Luz"
              class="form-control"
              v-model="inputs.numero_instalacao_luz"
            />
          </div>
        </div>
        <div class="col-5">
          <div class="form-group">
            <input
              type="text"
              placeholder="Fornecedor de luz"
              class="form-control"
              v-model="inputs.fornecedor_luz"
            />
          </div>
        </div>
      </div>
      ...
      <div class="row justify-content-center">
        <div class="col-5">
          <div class="form-group">
            <input
              type="text"
              placeholder="Número Habitese"
              class="form-control"
              v-model="inputs.numero_habitese"
            />
          </div>
        </div>
        <div class="col-5">
          <div class="form-group">
            <input
              type="text"
              placeholder="Data Habitese"
              class="form-control"
              v-model="inputs.data_habitese"
            />
          </div>
        </div>
      </div>
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-5">
          <div class="form-group">
            <input
              type="text"
              placeholder="Data Alvará"
              class="form-control"
              v-model="inputs.data_alvara"
            />
          </div>
        </div>
      </div>
      ...
      <div
        ...
        v-if="inputs.nome && inputs.numero && inputs.logradouro"
      >
