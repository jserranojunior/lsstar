            ...
            <table class="table table-striped table-condensed table-hover">
              <thead>
                <tr>
                  ...
                  <th v-if="$route.params.tipocliente == 'proprietarios'">Numero</th>
                </tr>
              </thead>
              <tbody>
                <tr
                  class="pointer"
                  v-for="(cliente, key, index) in clientes"
                  :key="cliente.id"
                  @click="edit(cliente.id)"
                >
                  <td>{{ index + 1 }}</td>
                  ...
                  <td v-if="$route.params.tipocliente == 'proprietarios'">
